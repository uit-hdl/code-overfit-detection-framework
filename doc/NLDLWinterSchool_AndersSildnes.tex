...
I use their pretrained inception for cancer detection.
...
Compare more biased photos, metrics using more advanced lines, e.g. 2d comparison.. or not, since they rely on having the same amount of points? What we want is to just not be biased to one..
