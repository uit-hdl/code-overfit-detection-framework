...
\begin{tikzpicture}[node distance=2cm and 2cm,
  ...
  inner/.style={draw=black!80,fill=gray!20,thick, inner sep=04pt},
  outer/.style={draw=black,fill=gray!10,thick,inner sep=08pt},
...
\end{tikzpicture} };
  \node[below=0.0cm of finetune, text width=4.2cm, align=center] (label3) {Sensitive variable TL};
