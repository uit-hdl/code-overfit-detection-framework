...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % \foreach \ColorVal [count=\Cont from 1] in 
    \pgfplotsforeachungrouped \foridx/\forcol in {1/red,2/violet,3/black,4/purple,5/orange,6/green,7/teal,8/blue} {
      ...
      % \expandafter\addlegendentry{Slide \foridx};
      \addlegendentrySI[]{Slide}{\foridx};
      }
  \end{axis}
\end{tikzpicture}
...
\maketitle
\umapPlot{fig:umapDefaultGood}{umapProjDefault}{8}
\umapPlot{fig:umapDefaultBad}{umapProjDefaultBad}{8}
...
% \end{figure}
% 
% \umapPlot{fig:umapgood}{umapProjDefault}{8}
% 
