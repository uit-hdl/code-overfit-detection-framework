...
def parse_args():
    ...
    parser.add_argument('--moco-dim', default=1536, type=int,
...
def adjust_learning_rate(optimizer, epoch, lr, cos, schedule, max_epochs):
    """Decay the learning rate based on schedule"""
    if cos:  # cosine lr schedule
        lr *= 0.5 * (1. + math.cos(math.pi * epoch / max_epochs))
