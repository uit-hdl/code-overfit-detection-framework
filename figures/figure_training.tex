    ...
    \foreach \y in {1,...,3}
    {
        \begin{scope}[yshift=\y*\shiftY]
            \foreach \x in {1,...,2}
            {
              ...
              \ifnum\y<2
                \pgfmathsetmacro\wsiName{int((\x-1)*\y+\x+1)}
                \node[yslant=0.5, fill=orange] (cswsi\y3) at ([shift={(\x*\shiftX+1,-6+\y*\shiftY)}]csBase) 
                {
                  {\includegraphics[width=.05\textwidth, height=.05\textheight]{./wsi\wsiName.png}}
            };
                \pgfmathsetmacro\wsiName{int((\x-1)*\y+\x+2)}
                \node[yslant=0.5, fill=blue] (cswsi\y4) at ([shift={(\x*\shiftX+2,-6+\y*\shiftY)}]csBase) 
                {
                  {\includegraphics[width=.05\textwidth, height=.05\textheight]{./wsi\wsiName.png}}
            };
              \else
                \ifnum\y<3
                \pgfmathsetmacro\wsiName{int((\x-1)*\y+\x+1)}
                \node[yslant=0.5, fill=green] (cswsi\y3) at ([shift={(\x*\shiftX+1,-6+\y*\shiftY)}]csBase) 
                {
                  {\includegraphics[width=.05\textwidth, height=.05\textheight]{./wsi\wsiName.png}}
            };
                \pgfmathsetmacro\wsiName{int((\x-1)*\y+\x+2)}
                \node[yslant=0.5, fill=orange] (cswsi\y4) at ([shift={(\x*\shiftX+2,-6+\y*\shiftY)}]csBase) 
                {
                  {\includegraphics[width=.05\textwidth, height=.05\textheight]{./wsi\wsiName.png}}
            };
              \else
