...
parser.add_argument('--feature_extractor', default='out/MoCo/tiles/model/relabelled_my_inst_checkpoint_MoCo_tiles_0200_False_m256_n0_o0_K256.pth.tar/network_epoch=7.pt', type=str, help='path to feature extractor, which will extract features from tiles')
...
def main():
    ...
    labels = slide_annotations["my_inst"].unique().tolist()
    labels.sort()
