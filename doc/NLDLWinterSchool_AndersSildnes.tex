...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+ [blue,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide0.csv};
    \addlegendentry{Slide 1}
    \addplot+ [red,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide1.csv};
    \addlegendentry{Slide 2}
    \addplot+ [yellow,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide2.csv};
    \addlegendentry{Slide 3}
    \addplot+ [black,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide3.csv};
    \addlegendentry{Slide 4}
    \addplot+ [purple,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide4.csv};
    \addlegendentry{Slide 5}
    \addplot+ [orange,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide5.csv};
    \addlegendentry{Slide 6}
    \addplot+ [green,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide6.csv};
    \addlegendentry{Slide 7}
    \addplot+ [pink,only marks,mark options={scale=.5}] table [col sep=comma] {./umap_proj_default/slide7.csv};
