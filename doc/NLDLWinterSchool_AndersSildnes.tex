...
\begin{figure*}
  \begin{subfigure}{.45\textwidth}
    \umapSubPlot{fig:umapDefaultGood}{umapProjDefault}{9}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
    \umapSubPlot{fig:umapOnly3Good}{only3Good}{9}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
    \umapSubPlot{fig:umap2augDefaultGood}{2augDefaultsGood}{9}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
    \umapSubPlot{fig:biasedUmap}{heavilyBiasedUmap}{4}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
    \umapSubPlot{fig:conditionFalse}{conditionFalse}{9}
  \end{subfigure}
  \begin{subfigure}{.45\textwidth}
  \begin{tikzpicture}
    \begin{axis}[
    ...
    % \pgfplotsforeachungrouped \foridx/\forcol in {1/red,2/violet,3/black,4/purple,5/orange,6/green,7/teal,8/blue} {
      % \ifnum\foridx<9
      % \expandafter\addplot\expandafter[\forcol,only marks,mark options={scale=.5}, fill opacity=.5, draw opacity=0.5] table [col sep=comma] {#2/slide\foridx.csv};
      % \addlegendimage{color=\forcol,mark=circle*};
      % \addlegendentrySI[]{Slide}{\foridx};
      % \fi
    \end{axis}
    \end{tikzpicture}
